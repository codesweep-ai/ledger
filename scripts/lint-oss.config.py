...
# The command this repository ships, as a reader types it: "cs-ledger".
...
# remote".
GITHUB_REPO = "codesweep-ai/ledger"
...
# would bury.
# GUIDE.md is a genuine standalone how-to: it is the doctrine shipped into every
# repository that keeps a ledger, and folding it would bury it.
EXTRA_DOCS = ["GUIDE.md"]
...
HOME_ALLOW = {"user", "you", "name", "runner"}
...
SKIP_PATHS = {
    "templates/": "a template materialized into a consumer repo, where its "
                  "relative links resolve; they do not resolve from here",
}
