...
GLOSSARY = ["ledger", "record", "draft", "stint", "queue", "viewer"]
...
# prompts. cs-ledger exits 1." as one 6-word sentence and reports a length that
# is not real.
LOWERCASE_STARTERS = ["cs-ledger"]
